...
namespace glfw
{
  ...
  public:
    ...
    IGL_INLINE int launch(bool resizable = true, bool fullscreen = false, const std::string &name = title, int width = 0, int height = 0);
    IGL_INLINE int launch_init(bool resizable = true, bool fullscreen = false, const std::string &name = title, int width = 0, int height = 0);
    ...
    IGL_INLINE std::string open_dialog_load_mesh();
